...
Each number corresponds to the max_height of a particular location, where 9 is 
...
The risk level of a low point is 1 plus its max_height. In the above example, 
...
Locations of max_height 9 do not count as being in any basin, and all other locations 
